...
func NewRouter(d Deps) http.Handler {
	...
	r.Route("/api/v1", func(api chi.Router) {
		...
		api.Group(func(private chi.Router) {
			...
			private.Get("/nodes/{nodeID}/adapters", d.handleListAdapters)
			private.Get("/nodes/{nodeID}/metrics", d.handleNodeMetrics)
			...
			private.Post("/subjects/{subjectID}/add-traffic", d.handleAddTraffic)
			private.Post("/subjects/{subjectID}/add-days", d.handleAddDays)
			private.Post("/subjects/{subjectID}/reset-traffic", d.handleResetTraffic)
			private.Get("/subjects/{subjectID}/traffic", d.handleGetSubjectTraffic)
			private.Get("/subjects/{subjectID}/activity", d.handleGetSubjectActivity)
			private.Get("/subjects/{subjectID}/ips", d.handleGetSubjectIPs)
			private.Get("/subjects/{subjectID}/audit", d.handleGetSubjectAudit)
			...
			private.Post("/subjects/bulk/add-traffic", d.handleBulkAddTraffic)
			private.Post("/subjects/bulk/add-days", d.handleBulkAddDays)
